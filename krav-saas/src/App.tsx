  ...
  return (
    <>
      <div className="flex flex-col justify-content-center items-center h-100">
        ...
        <button className="bg-green-400 text-white font-bold py-2 px-4 rounded hover:bg-green-500 transition duration-300">
          {" "}
          Reroll (0.19$){" "}
        </button>
        <button className="bg-red-400 text-white font-bold py-2 px-4 rounded hover:bg-green-500 transition duration-300">
          {" "}
          Boost (0.99$)
        </button>
      </div>
